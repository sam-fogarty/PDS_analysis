...
g++ collect_data_new.cpp daphne.cpp -o collect_data_new -ldaphne -lhdf5_cpp -lhdf5 #-I$ROOTSYS/include -L$ROOTSYS/lib -lCore -lRIO -lNet -lHist -lGraf -lGraf3d -lGpad -lTree -lRint -lPostscript -lMatrix -lPhysics -lMathCore -lThread -lGui -L. -ldaphne
