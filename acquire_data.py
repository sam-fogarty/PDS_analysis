...
if __name__ == "__main__":
    ...
    parser.add_argument('--nWaveforms', required=False, default=1000, help='Total number of waveforms to acquire per channel.')
    ...
    parser.add_argument('--VGAIN', required=False, default=None, help='VGAIN values to use in Volts. Separate values by comma, e.g. 0.0,0.1,0.2')
    parser.add_argument('--offset', required=False, default=1100, help='Initial offset value to use for tuning pedestals')
    parser.add_argument('--target_pedestal', required=False, default=2000, help='Target pedestal value for offset tuning.')
