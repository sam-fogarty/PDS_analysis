...
Shamelessly taken from https://github.com/marroyav/daphne_interface/blob/main/src/ivtools/DaphneInterface.py
but modified to handle ethernet timeouts (important for taking data through spi buffers). Don't treat this version of the script
as the latest, but should work for the scripts in this repo.

If one of the commands to DAPHNE takes too long, the code will repeat the command until it succeeds.
"""
